...
router.post('/addCarouselAction', function(req, res, next) {
    ...
    mysql.connect((db)=>{
        mysql.insert(db,'mainLunbo',insertObj,(result)=>{
            res.redirect('/mainLunbo');
            db.close();
        });
    })
});
...
router.get('/deleteCarousel', function(req, res, next) {
    ...
    mysql.connect((db)=>{
        mysql.deleteOne(db,'mainLunbo',deleteObj,(result)=>{
            res.redirect('/mainLunbo');
            db.close();
        });
    })
...
router.post('/updateCarouselAction', function(req, res, next) {
    ...
    mysql.connect((db)=>{
        mysql.updateOne(db,'mainLunbo',whereObj,updateObj,(result)=>{
            res.redirect('/mainLunbo');
            db.close();
        })
    })
